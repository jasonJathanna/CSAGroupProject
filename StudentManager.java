...
//Set schedule
            System.out.println("Enter in class codes (click enter after each code) for their current four classes:");
            for (int i = 0; i < 4; i++) {
...
//calculate percent grade from number grade
      int allNums = 0;
        for(Integer grade: students.get(index).getGrades() ) {
    	   allNums+=grade;
       }
        System.out.println("GPA: "+((allNums+0.0)/students.get(index).getGrades().size()) + "%");
        reader.nextInt();
//Return to homepage
        homePage();
...
// Change to string and display
        for(Integer theClass:students.get(index).getClasses()) {
//Math
        	if(theClass <100) {
        		System.out.println(theClass +" - Math");
        	} else if(theClass <100) {
//Science
        		System.out.println(theClass +" - Science");
        	} else if(theClass <200) {
//Social Studies
        		System.out.println(theClass +" - Social Studies");
        	} else if(theClass <300) {
//English
        		System.out.println(theClass +" - English");
        	} else if(theClass <400) {
//Elective
        		System.out.println(theClass +" - Elective");
        	} else {
//Off campus class
        		System.out.println(theClass +" - Off-campus class");
        	}
        }
